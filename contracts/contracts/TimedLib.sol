...
library TimedLib {
    ...
    /**
     *Check whether the proposal is finished or no
     *@notice When the end time is passed, some activites such as conclusion is thereby activated.
     */
    function isFinished(uint256 _currentTime, uint256 _end)
        internal
        pure
        returns (bool)
    {
    ...
    /**
     *Check if possible to schedule another proposal voting time in current GA

...
contract Wallet is Ownable {
    ...
    /**
     *fallback when receving money for unknown reason
     *@dev If some extra money received. Well, thank you.
     */
    receive() external payable {
        totalBalance = totalBalance.add(msg.value);
        individualContribution[msg.sender] = individualContribution[msg.sender]
            .add(msg.value);
    }

    /**
     *Increase the allowance of the account to withdraw
    ...
    /**
     *Accept the member to pay their membership fee, via Treasury
     *@dev
     */
        ...
        returns (bool)
    {
        ...
        individualContribution[_adr] = individualContribution[_adr].add(
            _amount
        );
    ...
    /**
     *Let beneficiary withdraw money, if the proposal is successful
    ...
    /**
     *When smth happened, change the external wallet addres to the new one. 
     ...
     *@param _adr the individual contribution address
     */
